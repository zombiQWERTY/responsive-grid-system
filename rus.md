...
Если вы используете препроцессор типа Sass, можете сделать из этого миксин, что позволит вам использовать этот код в разных местах:
...
Здесь начинаются сложности. Вам нужно по-разному рассчитать ширину колонок, в зависимости от используемого метода.
